export default function Navbar() {
    return(
        <div className="container">
            <nav className="row navbar bg-body">
                <div className="container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-hypnotize" viewBox="0 0 16 16">
                    ...
                    <p className="m-0 ms-2 font">Untitled UI</p>
                </div>
            </nav>
        </div>
    )
